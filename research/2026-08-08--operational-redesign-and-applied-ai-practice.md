...
The synthesis is implemented in the [FDE and applied AI engineering guide](../library/10-fde-and-production-agent-synthesis.md), [discovery and value playbook](../playbooks/01-discovery-and-value.md), [solution design and delivery playbook](../playbooks/02-solution-and-delivery.md), [FDE discovery pack](../templates/fde-discovery-pack.md), and [delivery and adoption plan](../templates/delivery-and-adoption-plan.md). The canonical controls remain `FDE-001` through `FDE-004`, `ARC-004`, `ARC-005`, `ADP-001`, `CTX-001`, and `CTX-002`.
