...
Use the migration note that matches the source contract version. Each note names the required artifact changes, validation gate, and rollback boundary.

- [Agent System 1.1](agent-system-1.1.md)
- [Agent System 1.2](agent-system-1.2.md)
...
- [Workflow Charter 1.1](workflow-charter-1.1.md)
- [Workflow Charter 1.2](workflow-charter-1.2.md)
