...
| [`examples/`](examples/invoice-exception/README.md) | Shows a controlled-write design and executable behavior | In-memory teaching implementation and regression surface |
